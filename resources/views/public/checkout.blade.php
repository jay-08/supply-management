...
@section('content')
<div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4 mt-4">
    <div>
        <h1 class="page-title fw-bold" style="color: #1e293b;">Review Request</h1>
        <p class="page-subtitle text-muted mb-0">Provide details and confirm your supply request.</p>
    </div>
</div>
...
<div class="row g-4" id="checkoutMainContainer">
    ...
    <div class="col-lg-7">
        <div class="card shadow-sm border-0" style="border-radius: 16px;">
            ...
            <div class="card-body p-4">
                <form action="{{ route('public.checkout.store') }}" method="POST" id="checkoutForm">
                    @csrf
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <a href="{{ route('public.catalog') }}" class="btn btn-light px-4 rounded-pill">Back to Catalog</a>
    ...
    <div class="col-lg-5">
        <div class="card shadow-sm border-0" style="background: var(--bs-gray-100); border-radius: 16px;">
...
<div class="text-center py-5 d-none" id="emptyCheckoutWarning">
    ...
    <a href="{{ route('public.catalog') }}" class="btn btn-primary px-4 mt-2 rounded-pill">Browse Catalog</a>
</div>
@endsection

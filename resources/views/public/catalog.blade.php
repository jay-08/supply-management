...
<div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4 mt-4">
    <div>
        <h1 class="page-title fw-bold" style="color: #1e293b;">Supply Catalog</h1>
        <p class="page-subtitle text-muted mb-0">Browse and add supplies to your request cart.</p>
    </div>
    <button class="btn btn-primary btn-lg shadow-sm rounded-pill px-4" type="button" data-bs-toggle="offcanvas" data-bs-target="#cartOffcanvas">
